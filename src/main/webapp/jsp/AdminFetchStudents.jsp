	...
	<div class="container" style="max-width: 1400px;">
		<div class="glass-card">
			<header>
				...
				<p style="text-align: center; color: var(--text-muted); margin-bottom: 2rem;">Review and manage student access permissions</p>
			</header>
				...
				<table>
					...
					<tbody>
						<c:forEach var="student" items="${students}">
							<tr>
								<td>
									<img class="student-pic" src="data:image/jpeg;base64,${Base64.encodeBase64String(student.getPicture())}" alt="Profile">
								</td>
								...
								<td>
									<a href="/admin/student/change-status/${student.getId()}" class="btn btn-outline" style="padding: 0.5rem 1rem; font-size: 0.8rem;">
										Toggle Status
									</a>
								</td>
							</tr>
