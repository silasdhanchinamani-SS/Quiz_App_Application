	...
	<div class="container" style="max-width: 1400px;">
		<div class="glass-card">
			<header>
				...
				<p style="text-align: center; color: var(--text-muted); margin-bottom: 2rem;">Review and verify trainer credentials</p>
			</header>
				...
				<table>
					...
					<tbody>
						<c:forEach var="trainer" items="${trainers}">
							<tr>
								<td>
									<img class="trainer-pic" src="data:image/jpeg;base64,${Base64.encodeBase64String(trainer.getPicture())}" alt="Profile">
								</td>
								...
								<td>
									<a href="/admin/trainer/change-status/${trainer.getId()}" class="btn btn-outline" style="padding: 0.5rem 1rem; font-size: 0.8rem;">
										Toggle Status
									</a>
								</td>
							</tr>
