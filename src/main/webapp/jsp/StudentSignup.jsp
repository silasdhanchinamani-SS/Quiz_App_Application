			...
			<div class="container">
				<div class="glass-card" style="max-width: 600px; margin: 0 auto;">
					<header>
						...
						<p style="text-align: center; color: var(--text-muted); margin-bottom: 2rem;">Create your
							student account to start learning</p>
					</header>

					<mvc:form action="/student/signup" method="post" modelAttribute="student"
