...
<title>Student Registration | Quiz Platform</title>
	...
	<div class="container">
		<div class="glass-card" style="max-width: 600px; margin: 0 auto;">
			<header>
				...
				<p style="text-align: center; color: var(--text-muted); margin-bottom: 2rem;">Create your student account to start learning</p>
			</header>
			
			<mvc:form action="/student/signup" method="post" modelAttribute="student" enctype="multipart/form-data">
				<div class="form-group">
					<label for="name">Full Name</label>
					<mvc:input path="name" placeholder="John Doe" />
					<div class="error-msg"><mvc:errors path="name" /></div>
				</div>
				
				<div class="form-group">
					<label for="email">Email Address</label>
					<mvc:input path="email" placeholder="john@example.com" />
